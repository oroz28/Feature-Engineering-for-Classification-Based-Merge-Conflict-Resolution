...
def preprocess_data(data):
    ...
    print("After filtering, number of projects:",
          data_filtered['project_id'].nunique())
    print("Label distribution:\n", data_filtered['label'].value_counts())

    return data_filtered


def remove_leakage_features(data, language='js_initial'):
    """
    ...
    if language != 'js_initial':
        cols_to_remove += ['programming_language', 'programming_language_code']
